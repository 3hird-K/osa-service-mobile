      ...
      <View style={{ paddingTop: insets.top + 16 }} className="px-6 pb-12">
        <View className="flex-row items-center justify-between">
          ...
          <View className="flex-row items-center">
            <Text className="text-primary-foreground/80 font-sans mr-2">Entered wrong email?</Text>
            <Link href="/(auth)/sign-up" asChild>
              <Pressable className="bg-primary-foreground/20 px-3 py-1.5 rounded-full">
                <Text className="text-primary-foreground font-sans font-semibold text-sm">Sign up</Text>
              </Pressable>
            </Link>
          </View>
        </View>
